...
??? note "Common configs to all connection types"
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                Enables VFS file caching to improve performance for repeated file operations. When enabled, file metadata is cached to reduce I/O operations.
            </td>
            <td>
                true
            </td>
        ...
        <tr>
            <td>
                Connection Suspension on Failure
            </td>
            <td>
                suspendOnConnectionFailure
            </td>
            <td>
                Boolean
            </td>
            <td>
                Enables connection suspension (circuit breaker pattern) when connection failures occur. When enabled, subsequent connection attempts are delayed after repeated failures to prevent overwhelming the server.
            </td>
            <td>
                true
            </td>
        ...
        <tr>
            ...
            <td>
                Number of connection retry attempts before activating suspension. If set to 0, suspension occurs immediately after the first failure.
            </td>
            <td>
                0
            </td>
        ...
        <tr>
            ...
            <td>
                Initial suspension duration in milliseconds. This is the waiting time before the first retry after suspension is activated.
            </td>
            <td>
                1000
            </td>
        ...
        <tr>
            ...
            <td>
                Factor by which suspension duration increases for each subsequent failure. For exponential backoff, use values > 1.0. For constant duration, use 1.0.
            </td>
            <td>
                1.0
            </td>
        ...
        <tr>
            ...
            <td>
                Maximum suspension duration in milliseconds. The suspension duration will not exceed this value regardless of progression factor.
            </td>
            <td>
                300000
            </td>
...
??? note "FTPS"
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                The password for the private key in the keystore. This is used when the private key has a different password than the keystore itself. Required for mutual SSL authentication when the private key is encrypted with a separate password.
            </td>
            <td>
                -
            </td>
...
??? note "SFTP"
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                When set to true, allows absolute path access starting from the root directory. When false (default), paths are relative to the user's home directory. This parameter enables access to system directories outside the user's home.</br>
                <b>Security Note</b>: Use with caution as it allows broader file system access.
            </td>
            <td>
                false
            </td>
...
<td>
POSIX permissions in octal notation to apply to created directories (e.g., "755", "644").
</td>
<td>
-
</td>
...
<td>
POSIX file permissions in octal notation (e.g., "644", "755"). Only works with local file system.
</td>
<td>
-
</td>
...
Yes
    ...
    **Sample configuration**
    ...
    <file.createDirectory configKey="CONNECTION_NAME">
        ...
        <autoCreate>{$ctx:autoCreate}</autoCreate>
        <permissions>{$ctx:permissions}</permissions>
        <updateFilePermission>{$ctx:updateFilePermission}</updateFilePermission>
...
Reads the content and metadata of a file at a given path. Metadata of the file is added as atrributes to the output variable while content is set as payload (or optionally overwrite the message body).
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                Time in milliseconds to wait between size checks for file stability verification. Ensures files are not actively being written before reading. If not specified or set to 0, file stability checking is disabled.
            </td>
            <td>
                0
            </td>
        ...
        <tr>
            ...
            <td>
                Format for file metadata output. Possible values: "json", "xml".
            </td>
            <td>
                json
            </td>
    ...
    **Sample configuration**
    ...
    <file.read configKey="CONNECTION_NAME">
        ...
        <timeBetweenSizeCheck>{$ctx:timeBetweenSizeCheck}</timeBetweenSizeCheck>
        <metadataOutputFormat>{$ctx:metadataOutputFormat}</metadataOutputFormat>
        <maxRetries>{$ctx:maxRetries}</maxRetries>
        <retryDelay>{$ctx:retryDelay}</retryDelay>
...
Unzip a specified file to a given location. If a folder with the same name exists, it is overwritten.
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                Time in milliseconds to wait between size checks for file stability verification. Ensures files are not actively being written before unzipping. If not specified or set to 0, file stability checking is disabled.
            </td>
            <td>
                0
            </td>
    ...
    <file.unzip configKey="CONNECTION_NAME">
        ...
        <fileNameEncoding>{$ctx:fileNameEncoding}</fileNameEncoding>
        <timeBetweenSizeCheck>{$ctx:timeBetweenSizeCheck}</timeBetweenSizeCheck>
...
Lists all the files (that match the specified pattern) in the directory path.
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                Type of pattern matching to use for file filtering.</br>
                <b>Possible Values</b>: wildcard, regex, ant.</br>
                <ul>
                    <li><b>wildcard</b>: Simple wildcard patterns (* and ?)</li>
                    <li><b>regex</b>: Regular expression patterns</li>
                    <li><b>ant</b>: Ant-style path patterns</li>
                </ul>
            </td>
            <td>
                wildcard
        ...
        <tr>
            ...
            <td>
                Pattern to include files. Uses the pattern type specified in fileFilterType.</br>
                <b>Examples</b>:
                <ul>
                    <li>Wildcard: *.txt, file*.csv</li>
                    <li>Regex: .*\.log$, ^data_\d{4}\.xml$</li>
                    <li>Ant: **/temp/*.tmp, data/**/processed/*</li>
                </ul>
            </td>
            <td>
                -
        ...
        <tr>
            ...
            <td>
                Pattern to exclude files. Uses the pattern type specified in fileFilterType. This filter is applied after the include filter.</br>
                <b>Examples</b>:
                <ul>
                    <li>Wildcard: *.tmp, .hidden*</li>
                    <li>Regex: .*\.bak$, ^temp_.*</li>
                    <li>Ant: **/backup/**, temp/**</li>
                </ul>
            </td>
            <td>
                -
        ...
        <tr>
            ...
            <td>
                Pattern to include directories in the listing. Uses the pattern type specified in fileFilterType.
            </td>
            <td>
                -
            </td>
        ...
        <tr>
            ...
            <td>
                Pattern to exclude directories from the listing. Uses the pattern type specified in fileFilterType.
            </td>
            <td>
                -
            </td>
        ...
        <tr>
            ...
            <td>
                Maximum age of files to include in milliseconds. Files older than this value will be excluded from processing.
            </td>
            <td>
                -
            </td>
        ...
        <tr>
            ...
            <td>
                Filter files by size in bytes. Can be used to include only files of specific size or within size ranges.
            </td>
            <td>
                -
            </td>
        ...
        <tr>
            ...
            <td>
                Start date for filtering files by modification date (ISO 8601 format: YYYY-MM-DDTHH:mm:ss).
            </td>
            <td>
                -
            </td>
        ...
        <tr>
            ...
            <td>
                End date for filtering files by modification date (ISO 8601 format: YYYY-MM-DDTHH:mm:ss).
            </td>
            <td>
                -
            </td>
    ...
    **Sample configuration**
    ...
    <file.listFiles configKey="CONNECTION_NAME">
        ...
        <fileFilterType>{$ctx:fileFilterType}</fileFilterType>
        <includeFiles>{$ctx:includeFiles}</includeFiles>
        <excludeFiles>{$ctx:excludeFiles}</excludeFiles>
        <includeDirectories>{$ctx:includeDirectories}</includeDirectories>
        <excludeDirectories>{$ctx:excludeDirectories}</excludeDirectories>
        <fileAge>{$ctx:fileAge}</fileAge>
        <fileSize>{$ctx:fileSize}</fileSize>
        <dateRangeFrom>{$ctx:dateRangeFrom}</dateRangeFrom>
        <dateRangeTo>{$ctx:dateRangeTo}</dateRangeTo>
        <maxRetries>{$ctx:maxRetries}</maxRetries>
        <retryDelay>{$ctx:retryDelay}</retryDelay>
...
Writes content to a specified file.
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                Time in milliseconds to wait between size checks for file stability verification. Ensures files are not actively being written before performing the write operation. If not specified or set to 0, file stability checking is disabled.
            </td>
            <td>
                0
            </td>
        ...
        <tr>
            ...
            <td>
                File permission in POSIX octal notation (e.g., "644", "755") to set on the file after writing. Only applicable for local file system operations. If not specified, default system permissions are used.
            </td>
            <td>
                -
            </td>
